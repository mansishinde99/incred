    ...
    <div className="footer">
      <div className="content">
        ...
        <div className="disclaimer">
          ...
          offer related documents carefully. The information contained herein is
          only to enable the Investor (or Lender) to make an informed decision.
          Any decision taken by the investor on the basis of this information is
          the sole responsibility of the Investor (Lender) and InCred Money is
          not liable. InCred Money has partnered with a third party platform
          regarding investments in various alternate investment opportunities.
          InCred Money will not be responsible for the full or partial loss of
          the principal and/or interest of the investor’s investment. InCred
          Money is only an intermediary introducing these third party services
          and is not responsible for any agreement you sign with the third
          party.
          <hr/> InCred Money has been launched with the acquisition of
          ...
          providing a comprehensive suite of investment products and services.
          <hr/>
          ORO FINANCIAL CONSULTANTS PRIVATE LIMITED is registered as a Stock
          Broker in New Debt Segment of BSE Limited having SEBI registration
          number: INZ000312534. 
          <hr/>
          InCred Money is a brand name and Alpha Fintech
          Private Limited is the platform provider for this website
          www.incredmoney.com.
          <hr/>
          </p>
        </div>
